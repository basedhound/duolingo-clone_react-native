...
function ControlButton({
  ...
  return (
    <TouchableOpacity style={styles.controlItem} onPress={onPress} activeOpacity={0.75}>
      <View
        style={[
...
export default function LessonScreen() {
  ...
  const teacherPhrase = LANG_PHRASE[language?.id ?? ''] ?? '¡Muy bien! That was great! 👋';
    ...
    <View style={styles.root}>
      ...
      <SafeAreaView style={styles.safeArea} edges={['top', 'bottom']}>
        ...
        <View style={styles.teacherArea}>
          ...
          {/* User camera preview (audio-only placeholder) */}
          <View style={styles.userPreview}>
            <Image
              source={{
                uri: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&q=80&fit=crop&crop=face',
              }}
        ...
        <View style={styles.controls}>
          ...
          />
          <ControlButton
            icon={micActive ? 'mic-outline' : 'mic-off-outline'}
            label="Mic"
            active={micActive}
...
const styles = StyleSheet.create({
  ...
  onlineText: { fontFamily: 'Poppins-Regular', fontSize: 12, color: '#21C16B' },
